#include "Servo.h" //biblioteca do servo para esp32

/*codigo copiado do projeto da UNIVERSIDADE TECNOLÓGICA FEDERAL DO PARANÁ
...
public:
   ...
   int compare()
   {
      ...
      if (rTop < rBottom && rTop < rLeft && rTop < rRight)
      { //Verifica se o menor eh o do topo
...
public:
   ...
   //Busca se e para onde deve mover, e chama o metodo correspondente para ocorrer esse movimento.
   void move()
   {
      pos = s.compare();
      switch (pos)
